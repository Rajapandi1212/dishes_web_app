...
const Navbar = () => {
  return (
    <div className="grid gap-3 grid-cols-[auto_minmax(200px,1fr)_70px] md:gap-5 md:pl-6 justify-between items-center px-2 py-1 md:py-4 border-b border-b-slate-300 mb-2">
      <Link href="/">
